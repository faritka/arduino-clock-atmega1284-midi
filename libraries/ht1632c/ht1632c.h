...
#define FONT_7x9CL 210
#define FONT_7x9CLB 211
#define FONT_4x6CL 220
...
public:
    ...
    void putbitmap(int x, int y, const uint16_t *bitmap, uint8_t w, uint8_t h, uint8_t color);
